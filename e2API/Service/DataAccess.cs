    ...
    public class DataAccess : IDataAccess
    {
            ...
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                while (reader.Read())
                {
                    CartItem item = new()
                    {
                        ...
                        Book = GetBook((int)reader["BookId"])
                    };
        ...
        public Book GetBook(int id)
        {
            ...
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                while (reader.Read())
                {
                    ...
                    book.ImageName = (string)reader["ImageName"];

                    var categoryid = (int)reader["CategoryId"];
                    book.BookCategory = GetBookCategory(categoryid);

                    var offerid = (int)reader["OfferId"];
                    book.Offer = GetOffer(offerid);
                }
            }
            return book;
        }
        ...
        public BookCategory GetBookCategory(int id)
        {
            ...
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                string query = "SELECT * FROM BookCategories WHERE CategoryId=" + id + ";";
                command.CommandText = query;
                ...
                while (r.Read())
                {
                    bookCategory.Id = (int)r["CategoryId"];
                    bookCategory.Category = (string)r["Category"];
                    bookCategory.SubCategory = (string)r["SubCategory"];
                }
            }
        ...
        public List<Book> GetBooks(string category, string subcategory, int count)
        {
        ...
        public bool InsertCartItem(int userId, int bookId)
        {
            using (SqlConnection connection = new(dbconnection))
            {
                SqlCommand command = new()
                ...
                query = "INSERT INTO CartItems (CartId, BookId) VALUES (" + cartId + ", " + bookId + ");";
                command.CommandText = query;
                command.ExecuteNonQuery();
                return true;
            }
        ...
        public void InsertReview(Review review)
        {
            ...
            string query = "INSERT INTO Reviews (UserId, BookId, Review, CreatedAt) VALUES (@uid, @pid, @rv, @cat);";
            command.CommandText = query;
            command.Parameters.Add("@uid", System.Data.SqlDbType.Int).Value = review.User.Id;
            command.Parameters.Add("@pid", System.Data.SqlDbType.Int).Value = review.Book.Id;
